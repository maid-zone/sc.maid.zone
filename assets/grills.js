(() => {
    ...
    document.body.append(E("div", { className: "image", style: "left: 0px;", children: [E("img", { src: `https://maid.zone/sprites/his/his_${his[Math.floor(Math.random() * his.length)]}.out.png` })] }))
    document.body.append(E("div", { className: "image", style: "right: 0px;", children: [E("img", { src: `https://maid.zone/sprites/koha/koha_${koha[Math.floor(Math.random() * koha.length)]}.out.png` })] }))
})()